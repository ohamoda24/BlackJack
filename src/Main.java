...
//                        players[j].hand.get(i).printCard();
    ...
    public void hitOrStand() {
        ...
        if (currentPlayer < 2) {
            ...
            if (players[currentPlayer].score > 21) {
                //automatic player ace handling
                if (players[2].hand.size() == 2) {
                    for (int i = 0; i < 2; i++) {
                        if (players[currentPlayer].hand.get(i).pointValue == 11) {
                            players[currentPlayer].score -= 10;
                        }
                    }
                } else if (players[2].hand.size() == 3) {
                    for (int i = 0; i < 3; i++) {
                        if (players[currentPlayer].hand.get(i).pointValue == 11) {
                            players[currentPlayer].score -= 10;
                        }
    ...
    public void dealerPlays() {
       ...
       players[2].printHand();
       System.out.println("Score: " + players[2].score);
        while (currentPlayer == 2) {
            ...
            if (players[2].score > 21) {
                ...
                if (players[2].score < 21 && players[2].score >= 17 || players[2].score == 17) {
                    System.out.println("Dealer score: " + players[2].score);
                    ...
                    System.out.println("Dealer stands.");
                    if (!players[2].isBust && !players[1].isBust && !players[0].isBust){
                        if (players[2].score > players[1].score && players[2].score > players[0].score) {
    ...
    public void checkScores() {
        ...
        System.out.println("Player 0 score: " + players[0].score);
        System.out.println("Player 1 score: " + players[1].score);
        System.out.println("Dealer score: " + players[2].score);

        if (players[0].isBust && players[1].isBust && players[2].isBust) {
            System.out.println("Everyone loses!");
            restart();
        }
        //players win
        if (players[0].isBust == false && players[1].isBust == false) {
            if (players[0].score > players[2].score && players[0].score > players[1].score) {
                System.out.println("PLAYER 0 WINS!");
            }
            if (players[1].score > players[2].score && players[1].score > players[0].score) {
                System.out.println("PLAYER 1 WINS!");
            }
        }

        //players win, other player busts
        if (players[1].score > players[2].score && players[0].isBust == true) {
            System.out.println("PLAYER 1 WINS!");
        }

        if (players[1].isBust == true && players[0].score > players[2].score) {
            System.out.println("PLAYER 0 WINS!");
        }
        ...
        //dealer wins
        if (players[2].isBust == false) {
            if (players[2].score > players[0].score && players[2].score > players[1].score) {
                System.out.println("Dealer wins!");
            } else if (players[2].score > players[0].score && players[0].isBust == true) {
                System.out.println("Dealer wins!");
            } else if (players[0].isBust == true && players[2].score > players[1].score) {
                System.out.println("Dealer wins!");
            } else if (players[0].isBust == true && players[0].isBust == true) {
                System.out.println("Dealer wins!");
            }
        } else {
        ...
        if (players[2].score == players[0].score) {
            System.out.println("The Dealer and Player 0 have tied. Click r to restart.");
        }
        if (players[2].score == players[1].score) {
            System.out.println("The Dealer and Player 1 have tied. Click r to restart.");
